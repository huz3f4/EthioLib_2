  ...
  return (
    <div className="bg-[#FAFAFA] min-h-screen pb-20">
              ...
              <div className="flex items-center space-x-2 bg-gray-50 p-1 rounded-xl w-fit">
                <button
                  ...
                  className={cn(
                    ...
                    !showGuides ? "bg-white text-indigo-600 shadow-sm" : "text-gray-500 hover:text-gray-700"
                  )}
                >
                  Student Textbooks
                </button>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6">
        <div className="bg-white p-4 rounded-2xl shadow-xl shadow-gray-100 border border-gray-50 overflow-x-auto">
          <div className="flex items-center space-x-2 min-w-max">
            <div className="flex items-center space-x-2 px-3 pr-6 border-r border-gray-100">
            ...
            <button
              ...
              className={cn(
                ...
                selectedGrade === 'all' ? "bg-indigo-600 text-white" : "text-gray-600 hover:bg-gray-50"
              )}
            >
              All
            </button>
            {grades.map(grade => (
              <button
                ...
                className={cn(
                  "px-4 py-2 rounded-xl text-xs font-bold transition-all",
                  selectedGrade === grade ? "bg-indigo-600 text-white" : "text-gray-600 hover:bg-gray-50"
                )}
              >
                Grade {grade}
              </button>
